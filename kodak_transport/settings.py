"""
Django settings for kodak_transport project.
...
SECRET_KEY = "django-insecure-qm1jgrdbbbps30_$f(v1+uz-r@rkdg9!n(=61sz)%#mdizi#mg"
...
ROOT_URLCONF = 'kodak_transport.urls'
...
WSGI_APPLICATION = 'kodak_transport.wsgi.application'
...
if ENVIRONMENT == 'production' or POSTGRES_LOCALLY:
    DATABASES = {
        'default': dj_database_url.parse('postgresql://postgres:JmfgPmeYxZrCSGRCvzxCOBGFmbWVzSmG@autorack.proxy.rlwy.net:57058/railway')
    }
